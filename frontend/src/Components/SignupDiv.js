    ...
    <div className='overlay'>
        <div className='sign-up-container'>
            ...
            <form action='/api/users' method='POST'>
                <input className='firstName' placeholder='First Name' name='firstName'/> 
                <input className='lastName' placeholder='Last Name' name='lastName' /> 
                <input type='email' className='email' placeholder='Email' name='email'/>
                <input type='password' className='password' name='password' placeholder='New password' />
                <div className='birthday'>Birthday</div>
                <input type='date' className='dateSelector' name='birthday'/>
                ...
                <select className="day" id="day" name="day">
